        ...
        <div class="auto-style15" style="border: 0px none #FFFFFF; background-color: #FFFFFF; margin-left: auto; margin-right: auto; margin-bottom: auto; height: 1478px;">
           <br />
            ...
            <br />
             <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div style="height: 75px; width: 232px; margin-left: 529px; margin-top: 0px; font-size: x-large; margin-bottom: 0px;" class="auto-style16"> 
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="False" Font-Overline="False" Text="出版物" Font-Names="黑体" Font-Size="X-Large"></asp:Label>
                </div> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div style="height: 107px; margin-top: 5px; margin-left: 77px;" class="auto-style18">
                        <asp:Label ID="Label7" runat="server" Font-Bold="True" Text="年份：" Font-Size="Larger"></asp:Label>
